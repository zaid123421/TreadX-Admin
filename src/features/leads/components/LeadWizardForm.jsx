...
import { handlePostalCodeChange, handlePhoneNumberChange, handleStreetNumberChange } from '../utils/leadUtils';
...
export function LeadWizardForm({
  ...
  return (
    <div className="w-full max-w-4xl">
      <div className={`rounded-xl border-s-4 border-s-primary shadow-xl ${crm.card} p-6 sm:p-8`}>
        <h3 className="text-lg font-semibold text-foreground tracking-tight">Lead information</h3>
        ...
        <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-x-6 sm:gap-y-5">
          <div className="space-y-2">
            <RequiredLabel htmlFor="businessName">Company / business name</RequiredLabel>
            <Input
              id="businessName"
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                handlePhoneNumberChange(e.target.value, (v) => handleInputChange('phoneNumber', v))
              }
              onKeyDown={(e) => {
                const allowed = [
                  '0',
          ...
          <div className="space-y-2">
            ...
            <Select value={formData.source} onValueChange={(value) => handleInputChange('source', value)}>
              <SelectTrigger className={`${crm.input} !w-full ${inputError('source')}`}>
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-3 sm:gap-x-6">
              <div className="space-y-2">
                ...
                {!loadingCountries && !countriesError && countries.length === 0 && (
                  <p className="text-sm text-muted-foreground">No countries returned from the server.</p>
                )}
          ...
          <div className="space-y-2 sm:col-span-2">
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-x-6">
              <div className="space-y-2">
                <RequiredLabel htmlFor="streetNumber">Street number</RequiredLabel>
                <Input
                  id="streetNumber"
              ...
              <div className="space-y-2">
                ...
                />
                {errors.streetName && <p className="text-sm text-destructive">{errors.streetName}</p>}
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                handlePostalCodeChange(e.target.value, (v) => handleInputChange('postalCode', v))
              }
              placeholder="A1A 1A1"
          ...
          <div className="space-y-2 sm:col-span-2">
            ...
            <div className="rounded-[10px] border border-dashed border-white/20 bg-[#1a2230]/80 px-4 py-6 text-center">
              ...
              {selectedFile && <p className="mt-2 text-sm text-primary">{selectedFile.name}</p>}
            </div>
          </div>
        ...
        <div className="mt-8 flex flex-col gap-4 border-t border-white/10 pt-6 sm:flex-row sm:items-center sm:justify-between">
          <p className={`text-sm ${crm.muted}`}>Required fields marked with *</p>
          <div className="flex flex-wrap justify-end gap-3">
            {onClose && (
              <Button type="button" variant="outline" onClick={onClose} className={crm.outlineBtn}>
                Cancel
              </Button>
            )}
            <Button
