    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Track and manage your tire business leads</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="flex flex-col items-center justify-center bg-muted/30 border border-border rounded-xl px-6 py-4 min-w-[120px] min-h-[90px]">
          ...
          <div className="font-bold text-xl text-foreground">{stats.pending}</div>
        </div>
        <div className="flex flex-col items-center justify-center bg-muted/30 border border-border rounded-xl px-6 py-4 min-w-[120px] min-h-[90px]">
          <CheckCircle className="h-6 w-6 text-success mb-1" />
          <div className="text-xs text-muted-foreground">Approved</div>
          <div className="font-bold text-xl text-foreground">{stats.approved}</div>
        </div>
        <div className="flex flex-col items-center justify-center bg-muted/30 border border-border rounded-xl px-6 py-4 min-w-[120px] min-h-[90px]">
          <PhoneCall className="h-6 w-6 text-info mb-1" />
          <div className="text-xs text-muted-foreground">Contacted</div>
          <div className="font-bold text-xl text-foreground">{stats.contacted}</div>
        </div>
      </div>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Select value={`${sortBy}-${sortDirection}`} onValueChange={handleSortPresetChange}>
              <SelectTrigger className="w-full sm:w-48">
                ...
                >
                  ...
                  <TableCell>
                    <div className="text-sm text-foreground">
                      ...
                      {lead.aptUnitBldg && <div className="text-muted-foreground">{lead.aptUnitBldg}</div>}
                      <div className="text-muted-foreground">{formatPostalCode(lead.postalCode)}</div>
                    </div>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <div className="text-sm text-foreground">{formatLeadDateShort(lead.createdAt)}</div>
                    {parseBackendDate(lead.updatedAt) && (
                      <div className="text-xs text-muted-foreground">Updated {formatLeadDateShort(lead.updatedAt)}</div>
                    )}
                    {lead.addedByName && (
                      <div className="text-xs text-muted-foreground">Added by {lead.addedByName}</div>
                    )}
                  </TableCell>
